...
namespace DimensionWebApp.Data
{
    public partial class DimensionDataWebContext : DbContext
    {
        public DimensionDataWebContext()
        {
        }

        public DimensionDataWebContext(DbContextOptions<DimensionDataWebContext> options)
            : base(options)
        {
        }
        ...
        public virtual DbSet<Cmpg323Project2Dataset3> Cmpg323Project2Dataset3 { get; set; }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. See http://go.microsoft.com/fwlink/?LinkId=723263 for guidance on storing connection strings.
                optionsBuilder.UseSqlServer("Initial Catalog=DimensionDataWeb;Data Source=LAPTOP-A5RCRTHU;Trusted_Connection=true");
            }
        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Cmpg323Project2Dataset3>(entity =>
            {
                entity.HasKey(x => x.EmployeeNumber);

                entity.ToTable("CMPG323 project 2 dataset (3)");
